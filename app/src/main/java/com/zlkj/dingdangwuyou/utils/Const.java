...
public class Const {
    ...
    public static final int PAY_TYPE_TASK = 0; //支付类型——任务塞红包
    public static final int PAY_TYPE_RECHARGE = 1; //支付类型——账户充值
    ...
    public static final int RESULT_CODE_REFRESH_AVATAR = 1003; //刷新用户头像
    public static final int RESULT_CODE_SAVE_SUCCEED = 1004; //保存成功
    public static final int RESULT_CODE_RELEASE_TASK_SUCCEED = 1005; //任务——发布成功
    public static final int RESULT_CODE_CONFIRM_TASK_SUCCEED = 1006; //任务——确认完成

    public static final int REQUEST_CODE_HIRE = 3000;
    public static final int REQUEST_CODE_CAMERA = 3001; //拍照
    public static final int REQUEST_CODE_GALLERY = 3002; //从相册选择
